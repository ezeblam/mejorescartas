                        ...
                        opciones: g.opciones.map((o) => {
                          ...
                          return {
                            ...
                            alergenos: encontrada
                              ? (encontrada.alergenos || []).filter((a) => ALERGENOS.includes(a))
                              : [],
                          };
                        }),
                      })),
                  ...
                  {(it.grupos || []).map((g) => (
                    <div key={g.id} style={S.publicGrupoOpciones}>
                      ...
                      {[...g.opciones]
                        ...
                        .map((o) => (
                          <div key={o.id} style={S.publicOpcionFila}>
                            <span>{o.nombre}</span>
                            <span style={S.publicOpcionDerecha}>
                              {o.alergenos && o.alergenos.length > 0 && (
                                <span style={S.opcionAlergenoPublico}>
...
const S = {
  ...
  opcionAlergenoPublico: { color: "#E0A85D", fontWeight: 600 },
