            ...
            content: [
              { type: "image", source: { type: "base64", media_type: mediaType, data: base64 } },
              {
                ...
                text:
                  ...
                  '{"categorias":[{"nombre":"Entrantes","items":[{"nombre":"Nombre del plato","precio":"0.00","desc":"","variantes":[],"alergenos":[],"necesitaRevision":false}]}]}. ' +
                  ...
                  "ADEMÁS, para cada plato, analiza el nombre y la descripción y rellena \"alergenos\" con los que probablemente contenga, usando EXACTAMENTE estos nombres (ninguno inventado): " +
                  '["Gluten","Crustáceos","Huevos","Pescado","Cacahuetes","Soja","Lácteos","Frutos de cáscara","Apio","Mostaza","Sésamo","Sulfitos","Altramuces","Moluscos"]. ' +
                  "Sé conservador: solo marca un alérgeno si el nombre/descripción lo indica con razonable certeza (ingredientes típicos de la receta, no solo posibilidad remota). " +
                  'Si el nombre del plato es genérico o ambiguo y no da información suficiente para deducir sus alérgenos con confianza (por ejemplo "Tosta de la casa", "Especial del chef", "Plato del día" sin más detalle), deja "alergenos" como array vacío y pon "necesitaRevision": true para avisar de que un humano debe revisarlo. En el resto de casos, "necesitaRevision" debe ser false.',
              },
            ],
          },
        ],
